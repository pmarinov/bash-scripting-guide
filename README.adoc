...
The _Advanced Bash-Scripting Guide_ is a book written by Mendel Cooper and part of The Linux
Documentation Project, page {guides}[Guides]. *This is a fork* of the
original work which had been (since 2014) dedicated to the *Public Domain*. 
