...
◊page-init{}
◊define-meta[page-title]{Sample .bashrc}
◊define-meta[page-description]{Sample .bashrc and .bash_profile Files}

The ◊fname{~/.bashrc} file determines the behavior of interactive
shells. A good look at this file can lead to a better understanding of
Bash.

Emmanuel Rouat contributed the following very elaborate
◊fname{.bashrc} file, written for a Linux system. He welcomes reader
feedback on it.

Study the file carefully, and feel free to reuse code snippets and
functions from it in your own ◊fname{.bashrc} file or even in your
scripts.
